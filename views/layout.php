    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a <?= $a_class ?> href="<?= getContextPath() ?>/index.php">Home</a></li>

          <li class="nav-item"><a <?= $a_class2 ?> href="<?= getContextPath() ?>/index.php?action=liste-adherents">Administration</a></li>

          <li class="nav-item"><a <?= $a_class3 ?> href="#!">Contact</a></li>
        </ul>
      </div>
    </div>
  </nav>
