...
<!-- liens du menu nav -->
<?php $a_class = 'class="nav-link active"' ?>
<?php $a_class2 = 'class="nav-link"' ?>
<?php $a_class3 = 'class="nav-link"' ?>

<!-- Header -->
<?php $header_style = "background-image: url('./assets/img/chat-profil.jpg'); height:435px; background-position: 50% 45%;"; ?>
<?php ob_start(); ?>
